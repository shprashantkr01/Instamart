...
import kselogonobg from '../assets/images/kselogonobg.png'
      ...
      <div className="row">
        <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
          <div className="col-md-8 me-auto">
            <p>The trending outfits at 10% off</p>
          </div>
          <div className="col-md-2">
          <a href="#">Call us at +91 9999999999</a>
          </div>
    ...
    <div className="row align-items-center m-0">
      ...
      <button className="navbar-toggler d-md-none " type="button" onClick={toggleMenu}>
        ...
        <Link to='/'>
          ...
          <img src={kselogonobg} alt="logo" className='img-fluid logo' />
        </Link>
