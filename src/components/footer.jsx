    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  Three town</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at +91 9999999999</a></p> </div>
          ...
          <Link id='footer-link' className='gap-3'>
          <BsDiscord />
          </Link>
          <Link  id='footer-link'  className='gap-3'>
          <BsTwitter />
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Prashant Kumar Sharma 2023</p>
        </div>
        <div className="col-12 col-md-6">
